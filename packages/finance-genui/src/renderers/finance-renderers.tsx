import { entry, listEntry, type ToolResultRenderer } from "../registry/entry";
...
// Tool name → { parse, render } for the finance tool results. Exported as the
// package's FINANCE_RENDERERS; a host app spreads it into its own tool-result
// registry. `entry`/`listEntry` come from ../registry/entry, the generic,
// tool-agnostic registry helpers.
//
