 ...
 * resolution event (`answeredOptionId` — fix-approval-replay — or
 * `answeredAnswers` — fix-question-replay) records an answer already given,
 * so neither may buzz the phone. */
