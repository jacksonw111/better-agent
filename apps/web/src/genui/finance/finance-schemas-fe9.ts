...
// liquidityUsd, outcomes: [{name, probability}] } (probability is 0..1).
// Split out as its own file — same pattern as finance-schemas-fe6/7/8.ts —
// since finance-schemas.ts is at the project's 300-line-per-file cap.
